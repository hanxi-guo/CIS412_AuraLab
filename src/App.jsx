...
export default function App() {
  ...
  const fbDefaultCaption =
    "The city hasn’t quite woken up yet.\n Light spills across the table, catching on the edge of the plate —\n  crisp folds, melting cream, a trace of chocolate still soft from the heat.\nThere’s something about quiet breakfasts that feels like a secret —\n  the world breathing slower,\n  a small reward for being here early.\nMaybe it’s not about coffee or pastries at all,\n  but about finding warmth before the day starts.\nStay for the second cup. ☕\n(all the sentences here is generated by ChatGPT here for insturction used)";
  const fbAnalysisText =
    "Tone Consistency: 92% — Strongly matches “Warm & Honest” campaign tone\n" +
    "Vibe Cluster: “Morning Rituals / Soft Light / Minimal Props”\n" +
    "Detected Mood: Calm · Intimate · Reflective";
  const fbFeedbackText =
    "This reads 90% on-brand for the “City Mornings” series.\n\n" +
    "Keep the tactile imagery (“first quiet bite”).\n\n" +
    "Try ending with a subtle invitation: “Stay for the second cup.”\n\n" +
    "🎯 Target Audience Match   Segment      Engagement    Fit     Notes\n" +
    "Young Professionals (20–30)  ✅ High     Tone resonates with weekday calm\n" +
    "Morning Ritual Lovers        ✅ High     Good sensory trigger\n" +
    "Aesthetic Lifestyle Followers ⚠️ Medium Could add more visual adjectives";
  ...
  function handleSavePost() {
    ...
    const newCard = {
      ...
      title: postTitle
        ? postTitle
        : postCaption
        ? (postCaption.length > 28 ? postCaption.slice(0, 28) + "…" : postCaption)
        : `${postPlatform} post`,
      date: dateLabel,
                    ...
                    return (
                      <div className={`post-sim-card ${platformClass}`}>
                        ...
                        <div className="post-caption-preview">
                          <strong>{postTitle || "Post title…"}</strong>
                          ...
                          <div className={`ai-vibe-box left ${isVibeLoading ? "loading" : ""}`}>
                            {isVibeLoading ? (
                              ...
                              <div className="ai-feedback-block">
                                <p className="ai-text">This reads 90% on-brand for the “City Mornings” series.</p>
                                <p className="ai-text">Keep the tactile imagery (“first quiet bite”).</p>
                                <p className="ai-text">Try ending with a subtle invitation: “Stay for the second cup.”</p>
                                <div className="ai-table-wrap">
                                  <table className="ai-table">
                                    ...
                                    <tbody>
                                      <tr>
                                        <td>Young Professionals (20–30)</td>
                                        <td>High</td>
                                        <td>High</td>
